...
class starter {
	public static void main(String args[]) {
		...
		if(num == right){
			...
			System.out.println("The number was " + right + " and your number was " + num + ", so your guess was LOWER THAN the correct answer.");
			System.out.println("It's OK though, it was pretty unlikely for you to guess the correct number in the first place.");
		}
		else if(right < num){
			System.out.println("The number was " + right + " and your number was " + num + ", so your guess was HIGHER THAN the correct answer.");
			System.out.println("It's OK though, it was pretty unlikely for you to guess the correct number in the first place.");
		}
	}
}
